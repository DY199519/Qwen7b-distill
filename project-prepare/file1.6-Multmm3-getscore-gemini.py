...
------------------------
Read top2 / top3 / top4 answers for each question from `claude_combined_answers.json`,
pair them up (3 groups in total), and use gpt-4o to score them with 5×100 criteria and determine the winner.
"""
...
# ========== Path Settings ====================================================
INPUT_PATH  = r"D:\project\gemini_combined_answers.json"
OUTPUT_DIR  = r"D:\project"
OUTPUT_NAME = "pairwise_grades_top234_gemini.json"
...
# ========== Main Process (Remove Direct Pairs) ===============================
def main():
    ...
    print(f"🌟 A total of {len(valid_items)} questions entered pair scoring, with {total_pairs} pairs in total")

    done = 0
    with tqdm(total=total_pairs, desc="Pair Scoring Progress") as pbar:
