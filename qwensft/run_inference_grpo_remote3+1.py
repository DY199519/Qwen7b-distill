        ...
        if 'high_quality_crossdisciplinary_questions' in content:
            try:
                ...
                if 'high_quality_crossdisciplinary_questions' in local_namespace:
                    ...
                    print(f"✓ Successfully loaded {len(questions)} questions using exec method")
            ...
            try:
                ...
                if start_idx != -1:
                    ...
                    try:
                        ...
                        print(f"✓ Successfully loaded {len(questions)} questions using ast.literal_eval")
                    except:
...
def run_batch_inference_with_checkpoint(questions, model_path, adapters_path, output_file, input_file):
    ...
    for idx, (question_index, question) in enumerate(to_process, 1):
        ...
        while retry_count < max_retries:
            ...
            if answer and len(answer) >= 20:
                ...
                if answer:
                    ...
                    print(f"  ⚠ Failed to generate answer, retrying {retry_count}/{max_retries}")
        ...
        if not answer or len(answer) < 20:
            answer = f"Inference failed: Answer generation incomplete or too short (failed after {max_retries} retries)"
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            if version:
                ...
                print("✗ ms-swift installation information invalid")
                return False
        else:
